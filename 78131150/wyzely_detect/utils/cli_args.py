...
def set_argparse():
    ...
    video_options.add_argument(
        ...
        default=(
            os.environ["FORCE_DISABLE_TENSORFLOW_GPU"]
    ...
    timers.add_argument(
        "--notification-window",
        default=(
            os.environ["NOTIFICATION_WINDOW"]
    ...
    face_recognition.add_argument(
        ...
        default=(
            os.environ["FACE_CONFIDENCE_THRESHOLD"]
    ...
    face_recognition.add_argument(
        ...
        default=(
            os.environ["NO_REMOVE_REPRESENTATIONS"]
    ...
    object_detection.add_argument(
        ...
        default=(
            os.environ["OBJECT_CONFIDENCE_THRESHOLD"]
